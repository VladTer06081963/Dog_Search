    ...
    const res = await fetch("https://api.openai.com/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "user",
            content: `Расскажи о породе собак, найди и выдай их название в украинской и русской википедии. 
Если таких названий нет в википедиях, напиши — «данних попороде нет  "${breed}"`,
          },
        ],
      }),
    });
